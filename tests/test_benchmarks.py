...
from mora.utils import set_log_level, LOG_NOTHING, make_symbols_positive
...
def prepare_moment(moment):
    return sympify(str(moment))
...
class TestBenchmarks(unittest.TestCase):
    ...
    def test_cc_1(self):
        ...
        self.assertEqual(simplify(prepare_moment(moments[f]) - result), 0)
        result = prepare_result("1 - 2**(-n)")
        self.assertEqual(simplify(prepare_moment(moments[c]) - result), 0)
        result = prepare_result("1 - 2**(-n)")
        self.assertEqual(simplify(prepare_moment(moments[d]) - result), 0)
    ...
    def test_cc_2(self):
        ...
        result = prepare_result("1/2")
        self.assertEqual(simplify(prepare_moment(moments[f**2]) - result), 0)
        result = prepare_result("1 - 2**(-n)")
        self.assertEqual(simplify(prepare_moment(moments[c**2]) - result), 0)
        result = prepare_result("1 - 2**(-n)")
        self.assertEqual(simplify(prepare_moment(moments[d**2]) - result), 0)
    ...
    def test_cc4_1(self):
        ...
        self.assertEqual(simplify(prepare_moment(moments[f]) - result), 0)
        result = prepare_result("1/2")
        self.assertEqual(simplify(prepare_moment(moments[g]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[a]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[b]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[c]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[d]) - result), 0)
    ...
    def test_cc4_2(self):
        ...
        self.assertEqual(simplify(prepare_moment(moments[f**2]) - result), 0)
        result = prepare_result("1/2")
        self.assertEqual(simplify(prepare_moment(moments[g**2]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[a**2]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[b**2]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[c**2]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[d**2]) - result), 0)
    ...
    def test_cc4_3(self):
        ...
        self.assertEqual(simplify(prepare_moment(moments[f**3]) - result), 0)
        result = prepare_result("1/2")
        self.assertEqual(simplify(prepare_moment(moments[g**3]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[a**3]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[b**3]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[c**3]) - result), 0)
        result = prepare_result("-3**n*4**(-n) + 1")
        self.assertEqual(simplify(prepare_moment(moments[d**3]) - result), 0)
    ...
    def test_duelling_cowboys_2(self):
        ...
        result = prepare_result("a")
        self.assertEqual(simplify(prepare_moment(moments[ahit**2]) - result), 0)
        result = prepare_result("a**2*b - 2*a*b + b")
        self.assertEqual(simplify(prepare_moment(moments[bhit**2]) - result), 0)
    ...
    def test_duelling_cowboys_3(self):
        ...
        result = prepare_result("a")
        self.assertEqual(simplify(prepare_moment(moments[ahit**3]) - result), 0)
        result = prepare_result("-a**3*b + 3*a**2*b - 3*a*b + b")
        self.assertEqual(simplify(prepare_moment(moments[bhit**3]) - result), 0)
    ...
    def test_product_dep_var_1(self):
        ...
        self.assertEqual(simplify(prepare_moment(moments[p]) - result), 0)
    ...
    def test_product_dep_var_2(self):
        ...
        self.assertEqual(simplify(prepare_moment(moments[p**2]) - result), 0)
    ...
    def test_product_dep_var_3(self):
        ...
        self.assertEqual(simplify(prepare_moment(moments[p**3]) - result), 0)
    ...
    def test_stuttering_a_1(self):
        ...
        self.assertEqual(simplify(prepare_moment(moments[s]) - result), 0)
    ...
    def test_stuttering_a_2(self):
        ...
        self.assertEqual(simplify(prepare_moment(moments[s**2]) - result), 0)
